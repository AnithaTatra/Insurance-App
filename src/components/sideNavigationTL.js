    ...
    return (
        <div className="sidebar-fixed position-fixed">
            ...
            <MDBListGroup className="list-group-flush">
                ...
                <MDBListGroupItem>
                <Nav.Menu eventKey="3" title="Task Allocation" icon={<Rate />} >
                <Nav.Item eventKey="3-1"><NavLink to="/taskAllocation"> Allocation</NavLink></Nav.Item>
                <Nav.Item eventKey="3-2"><NavLink to="/viewTaskAllocation"> ViewAllocaton</NavLink></Nav.Item>
          </Nav.Menu>
                ...
                <MDBListGroupItem>
                {/* <Nav.Menu eventKey="3" title="Location Manage" icon={<Rate />} > */}
