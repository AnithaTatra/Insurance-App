...
const AddBusiness=() => {
  ...
  const Validations = event => {
    if(event.target.value==""){
      setRoleCodeMessage("Please Fill The Language Name");
    }else{
      setRoleCodeMessage('');
    }
  };
...
const SaveRoles=()=>{
  ...
  if(rolecode=="" || rolename=="" || locationName=="" || status==""){
    ...
    axios.post('http://localhost:4000/api/v5/language/addLanguage', addroles)
  .then((response) => {
            ...
            <div className="col-12 col-md-7 col-lg-6 auth-main-col text-center">
                <div className="d-flex flex-column align-content-end">
                    ...
                    <fieldset class="border p-2">
                      ...
                      <legend  class="float-none w-auto">Add Language</legend>
                        <div className="auth-form-container text-start">
                                ...
                                <div className="name mb-3">
                                <Select options={actions} id="status" placeholder="Language Status "  />
                                <p>{statusmessage}</p>
                                <p>{message}</p>
